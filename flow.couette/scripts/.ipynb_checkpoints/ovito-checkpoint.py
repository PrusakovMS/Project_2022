...
pipeline = import_file("/home/common/studtscm15/project/flow.couette/scripts/dump.flow")
...
vp.render_anim(size=(400,400), filename = "couette.mp4", renderer=vis.TachyonRenderer(), range = (0, 20))
